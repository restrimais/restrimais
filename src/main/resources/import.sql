INSERT INTO tb_patient (name, email, birth_date, password, cpf, gender, profile_img, phone, height, weight) VALUES ('Bob Brown', 'bob@gmail.com', '2001-07-25', '$2a$10$6.KwfIfe695nY3eirYJLxui4FLZpXMzs66cfd7y9YB9XocWxPxa8q', '45678998709', 0, 'https://raw.githubusercontent.com/devsuperior/dscatalog-resources/master/backend/img/1-big.jpg', '988889999', 1.75, 68.0);
INSERT INTO tb_patient(name, email, birth_date, password, cpf, gender, profile_img, phone, height, weight) VALUES ('Maria Silva', 'maria@gmail.com', '2007-08-18', '$2a$10$6.KwfIfe695nY3eirYJLxui4FLZpXMzs66cfd7y9YB9XocWxPxa8q', '44455566609', 1, 'https://raw.githubusercontent.com/devsuperior/dscatalog-resources/master/backend/img/1-big.jpg', '955557777', 1.60, 55.0);
...
INSERT INTO tb_nutritionist (name, email, birth_date, password, cpf, gender, profile_img, phone, crn, specialization, academic_degree, biography, score, count) VALUES ('Ana Luiza', 'ana@gmail.com', '2002-10-08', '$2a$10$6.KwfIfe695nY3eirYJLxui4FLZpXMzs66cfd7y9YB9XocWxPxa8q', '44455566609', 1, 'https://raw.githubusercontent.com/devsuperior/dscatalog-resources/master/backend/img/1-big.jpg', '955557777', 'CRM/SP 123456', 'Nutricao Esportiva', 'Bacharelado em Nutricao', 'Nutricionista Esportiva dedicada a otimizar desempenho e saúde. Graduada em Nutrição pela [Nome da Universidade], com especialização em Nutrição Esportiva pela [Nome da Instituição]. Meu foco é fornecer orientação personalizada para ajudar meus clientes a alcançar seus objetivos. Apaixonada por promover educação em saúde, sou palestrante em eventos esportivos e escolas. Acredito que a nutrição e um estilo de vida ativo são a chave para o bem-estar.', 0, 0);

INSERT INTO tb_role (authority) VALUES ('ROLE_CLIENT');
INSERT INTO tb_role (authority) VALUES ('ROLE_ADMIN');

INSERT INTO tb_patient_role (patient_id, role_id) VALUES (1, 1);
INSERT INTO tb_patient_role (patient_id, role_id) VALUES (1, 2);
INSERT INTO tb_patient_role (patient_id, role_id) VALUES (2, 1);

INSERT INTO tb_nutritionist_role (nutritionist_id, role_id) VALUES (1, 1);
...
INSERT INTO tb_assessment_revenue(valor, patient_id, revenue_id, comment) VALUES (5.0, 1, 1, 'Boa receita.');
INSERT INTO tb_assessment_revenue(valor, patient_id, revenue_id, comment) VALUES (4.0, 2, 1, 'Gostei muito.');
